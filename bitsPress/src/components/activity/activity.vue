          ...
          <el-col :span="9">
            <el-card class="box-card">
              ...
              <ul class="product-list">
                <li class="product-item" v-for="(aItem, aIndex) in activeData" :key="aIndex">
                  <p class="pro-title">{{aItem.title}}</p>
                  <p class="pro-desc">{{aItem.title}}</p>
                </li>
                <li class="empty-box" v-if="activeData.length <= 0">暂无商品</li>
              </ul>
            </el-card>
          </el-col>
          <el-col :span="15">
...
export default {
  ...
  methods: {
    getData () {
      ...
      this.activeData = Data.data.slice(12, 32);
